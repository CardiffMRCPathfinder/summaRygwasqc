...
### Pvalue class
if(class(GWAS[,p.val.col])=="character" | class(GWAS[,frq.col])=="numeric"){
...
### Info class
if(length(info.matches)>0){
  if(class(GWAS[,info.col])=="character" | class(GWAS[,frq.col])=="numeric"){
...
### Effect size class
if((length(beta.matches)>0 | length(or.matches)>0 | length(z.matches)>0) & class(GWAS[,effect.col])=="character" | class(GWAS[,frq.col])=="numeric"){
